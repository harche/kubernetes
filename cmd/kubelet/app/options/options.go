...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.BoolVar(&c.EnableCompressibleReserved, "enable-compressible-reserved", c.EnableCompressibleReserved, "Enables setting compressible resources on reserved (system or kube) cgroups.")
