...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ImageDecryptServiceSecret)(nil), (*core.ImageDecryptServiceSecret)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ImageDecryptServiceSecret_To_core_ImageDecryptServiceSecret(a.(*v1.ImageDecryptServiceSecret), b.(*core.ImageDecryptServiceSecret), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ImageDecryptServiceSecret)(nil), (*v1.ImageDecryptServiceSecret)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ImageDecryptServiceSecret_To_v1_ImageDecryptServiceSecret(a.(*core.ImageDecryptServiceSecret), b.(*v1.ImageDecryptServiceSecret), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ImageDecryptServiceSecret_To_core_ImageDecryptServiceSecret(in *v1.ImageDecryptServiceSecret, out *core.ImageDecryptServiceSecret, s conversion.Scope) error {
	out.Name = in.Name
	out.Images = *(*[]string)(unsafe.Pointer(&in.Images))
	return nil
}

// Convert_v1_ImageDecryptServiceSecret_To_core_ImageDecryptServiceSecret is an autogenerated conversion function.
func Convert_v1_ImageDecryptServiceSecret_To_core_ImageDecryptServiceSecret(in *v1.ImageDecryptServiceSecret, out *core.ImageDecryptServiceSecret, s conversion.Scope) error {
	return autoConvert_v1_ImageDecryptServiceSecret_To_core_ImageDecryptServiceSecret(in, out, s)
}

func autoConvert_core_ImageDecryptServiceSecret_To_v1_ImageDecryptServiceSecret(in *core.ImageDecryptServiceSecret, out *v1.ImageDecryptServiceSecret, s conversion.Scope) error {
	out.Name = in.Name
	out.Images = *(*[]string)(unsafe.Pointer(&in.Images))
	return nil
}

// Convert_core_ImageDecryptServiceSecret_To_v1_ImageDecryptServiceSecret is an autogenerated conversion function.
func Convert_core_ImageDecryptServiceSecret_To_v1_ImageDecryptServiceSecret(in *core.ImageDecryptServiceSecret, out *v1.ImageDecryptServiceSecret, s conversion.Scope) error {
	return autoConvert_core_ImageDecryptServiceSecret_To_v1_ImageDecryptServiceSecret(in, out, s)
}
...
func autoConvert_v1_ServiceAccount_To_core_ServiceAccount(in *v1.ServiceAccount, out *core.ServiceAccount, s conversion.Scope) error {
	...
	out.ImagePullSecrets = *(*[]core.LocalObjectReference)(unsafe.Pointer(&in.ImagePullSecrets))
	out.ImageDecryptSecrets = *(*[]core.ImageDecryptServiceSecret)(unsafe.Pointer(&in.ImageDecryptSecrets))
	out.AutomountServiceAccountToken = (*bool)(unsafe.Pointer(in.AutomountServiceAccountToken))
	return nil
}
...
func autoConvert_core_ServiceAccount_To_v1_ServiceAccount(in *core.ServiceAccount, out *v1.ServiceAccount, s conversion.Scope) error {
	...
	out.ImagePullSecrets = *(*[]v1.LocalObjectReference)(unsafe.Pointer(&in.ImagePullSecrets))
	out.ImageDecryptSecrets = *(*[]v1.ImageDecryptServiceSecret)(unsafe.Pointer(&in.ImageDecryptSecrets))
	out.AutomountServiceAccountToken = (*bool)(unsafe.Pointer(in.AutomountServiceAccountToken))
	return nil
}
