...
var (
	...
	// EventedPLEGConn is a Counter that tracks the number of times the connection was
	// successfully established with the CRI Runtime.
	EventedPLEGConn = metrics.NewCounter(
		&metrics.CounterOpts{
			Subsystem:      KubeletSubsystem,
			Name:           EventedPLEGConnKey,
			Help:           "The number of times the connection was successfully established with the CRI Runtime.",
			StabilityLevel: metrics.ALPHA,
		},
	)
